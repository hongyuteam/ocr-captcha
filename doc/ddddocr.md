...
python main.py --port 9898 --ocr

# 开启ocr模块并使用旧模型计算
python main.py --port 9898 --ocr --old

# 只开启目标检测模块
python main.py --port 9898  --det

# 同时开启ocr模块以及目标检测模块
python main.py --port 9898 --ocr --det

# 同时开启ocr模块并使用旧模型计算以及目标检测模块
python main.py --port 9898 --ocr --old --det
